...
import { ReactComponent as RightArrow2 } from '../../Assets/assets/main/ArrowRight2.svg';
import { ReactComponent as RightArrow3 } from '../../Assets/assets/main/ArrowRight3.svg';
...
const  Pagination = ({ pages = 10, setCurrentPage }) => {
  ...
  useEffect(() => {
    ...
    return (
        ...
        <a
          href="#"
          className={`last ${currentButton === numberOfPages.length ? 'disabled' : ''}`}
